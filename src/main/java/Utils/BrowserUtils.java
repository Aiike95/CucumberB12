...
public class BrowserUtils {
    //Browser UTILS is located for the reusable methods.
    ...
    public static void getScreenShot(WebDriver driver,String packageName){
        ...
        try {
            FileUtils.copyFile(file,new File(location+System.currentTimeMillis())); /*System.currentTimeMillis will
            make the data unique all the time.*/
        } catch (IOException e) {
            e.printStackTrace();
        }
